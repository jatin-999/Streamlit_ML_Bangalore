...
def main():
    ...
    location_options = read_location_options('C:\\Users\91992\Desktop\ML Housing Price Predictions\columns.json')
...
def read_location_options(json_file):
    ...
    with open(r"C:\Users\91992\Desktop\ML Housing Price Predictions\bangalore_ML_predictions.pickle", 'rb') as file:
